...
public class Descriptor
{
      ...
      public static void main(String[] args)
      {
                  ...
                  if (decorations != null)
                  {
                        ...
                        for (Decoration decoration : decorations.decorations)
                        {
                              if (decoration.planGUID != null)
                                    ...
                                    System.out.println(String.format("[GatherTask] Decoration[%d]" +
                                                                     " missing " +
                                                                     "PlanGUID (ThingUID=%d)",
                                            index, thing.UID));
                              index++;
                  ...
                  if (stickers != null)
                  {
                        ...
                        for (Decal decal : stickers.decals)
                        {
                              if (decal.plan != null)
                              {
                                    ...
                                    System.out.println(String.format("[GatherTask] Decal[%d] " +
                                                                     "missing PlanGUID" +
                                                                     " (ThingUID=%d)", index,
                                            thing.UID));
                              index++;
            ...
            if (missing.size() != 0)
            {
                  System.out.println(String.format("[%s] Found %d missing plan descriptors",
