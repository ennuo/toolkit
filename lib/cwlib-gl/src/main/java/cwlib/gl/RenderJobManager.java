...
public class RenderJobManager
{
      ...
      private void Setup()
      {
            ...
            glEnable(GL_FRAMEBUFFER_SRGB);
            {
                  ...
                  glTexImage2D(GL_TEXTURE_2D, 0, GL_SRGB_ALPHA, RENDER_TARGET_WIDTH, RENDER_TARGET_HEIGHT, 0, GL_RGBA,
            ...
            glDisable(GL_FRAMEBUFFER_SRGB);
            {
                  ...
                  glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, RENDER_TARGET_WIDTH, RENDER_TARGET_HEIGHT, 0, GL_RGBA,
                          GL_UNSIGNED_BYTE,
                          (ByteBuffer) null);
                  glTexParameterIi(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
                  glTexParameterIi(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
