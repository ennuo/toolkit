...
public class Revisions
{
    ...
    public static final int DEPENDENCIES = 0x109; // Added self describing depenency table to
    // resources
    ...
    public static final int CLEANUP_CLEANUP_EVERYBODY_EVERYWHERE = 0x13c; // removed PPaint,
    ...
    public static final int SCRIPT_FISH_TYPE = 0x145; // added fishType to FieldLayoutDetails in
    // PScript
    // 0x146
    public static final int BODY_FROZEN_MODE = 0x147; // replaced frozen boolean with frozen mode
    // in PBody
    public static final int REMOVE_PRIMITIVE_GMAT = 0x149; // removed alternate gfx material from
    // Primitive
    ...
    public static final int DETAILS_SOUND_GUID = 0x14f; // highlightSound uses GUID instead of
    // string in InventoryItemDetails
    public static final int PROFILE_PLAYER_ID = 0x150; // added playerId to RLocalProfile
    // 0x151
    public static final int WORLD_COLOR_CORRECTION = 0x152; // Added lighting and color
    // correction factor to PWorld
    public static final int LIGHTING_PRESETS = 0x153; // Added presets to LevelSettings, also
    ...
    public static final int DECAL_METADATA = 0x158; // added type, metadataIdx, numMetadata to
    // decal
    public static final int UNIFED_TRANSLATION_TAG = 0x159; // use one translation tag instead of
    ...
    public static final int EGGLINK_DETAILS = 0x160; // Reference CInventoryItemDetails in
    // CEggLink for item details
    // 0x161
    public static final int DETAILS_EYETOY_DATA = 0x162; // eyetoyData added to
    // InventoryItemDetails
    // 0x163
    // 0x164
    public static final int AUDIOWORLD_IS_LOCAL = 0x165; // Added isLocal to PAudioWorld
    // 0x166
    public static final int MATERIAL_EXPLOSIONS = 0x167; // Added explosion and breakable fields
    // to RMaterial
    public static final int MATERIAL_ANGULAR_EXPLOSIONS = 0x168; // Added explosionMaxAngVel to
    // RMaterial
    // 0x169
    ...
    public static final int UNLOCKS_REWARDS = 0x16f; // Added unlocks and rewards to PWorld, and
    ...
    // 0x173
    public static final int DETAILS_SINGLE_TRANSLATION_TAG = 0x174; // replace nameTranslationTag
    ...
    public static final int DETAILS_LEVEL_UNLOCK = 0x177; // add levelUnlockSlotID to
    // InventoryItemDetails
    // 0x178
    public static final int MESH_TEXTURE_ALTERNATIVES = 0x179; // textureAlternatives added to
    // CPrimitive
    // 0x17a, added unknown boolean to PScript, removed in 0x1a1
    // 0x17b
    // 0x17c
    // 0x17d
    public static final int PROFILE_LBP1_VIDEOS_PLAYED = 0x17e; // added lbp1VideosPlayed to
    // RLocalProfile
    // 0x17f
    // 0x180, added unknown boolean and NetworkPlayerID to PRef, removed in 0x19e, removes field
    // added in 0x172
    // 0x181
    public static final int DETAILS_PHOTO_DATA = 0x182; // photoData, copyright, and creator
    // added to InventoryItemDetails
    public static final int SLOT_TRANSLATION_TAG = 0x183; // Added translationTag to slot
    public static final int METRICS_MULTIPLAYER_GAMES = 0x184; // added multiplayerGamesCount to
    // PlayerMetrics
    // 0x185
    // 0x186
    // 0x187
    // 0x188, removed unknown field from Slot
    public static final int COMPRESSED_RESOURCES = 0x189; // Added optional compressed field to
    // resources
    // 0x18a
    // 0x18b
    public static final int REMOVE_PARTICLE_EMITTER_2 = 0x18c; // Removed PParticleEmitter2
    public static final int JOINT_SLIDE_STIFFNESS = 0x18d; // added slideDir to PJoint, replaced
    // stiff with a float
    ...
    // 0x192
    // 0x193
    public static final int YELLOWHEAD_ON_SCREEN_COUNTER = 0x194; // Added onScreenCounter to
    // PYellowHead
    public static final int DETAILS_PRIMARY_INDEX = 0x195; // Added primaryIndex to
    // InventoryItemDetails
    public static final int WORLD_FOG_FACTOR = 0x196; // Added fog/darkness settings to PWorld
    public static final int PLAN_DETAILS = 0x197; // Plan details added to RPlan, removed
    ...
    public static final int TRIGGER_HYSTERESIS = 0x19b; // add hysteresisMultplier and enabled to
    // PTrigger
    // 0x19c
    public static final int SCRIPT_REFLECT_DIVERGENT = 0x19d; // added reflectDivergent to
    ...
    // added in 0x17a
    public static final int PROFILE_AUDIO_SWITCHES = 0x1a2; // added voipMutedPlayers,
    ...
    public static final int DYNAMIC_SWITCHES = 0x1a5; // added type to PSwitch, switches now
    // carry activation
    ...
    // 0x1a8
    public static final int ENEMY_ANIMATION = 0x1a9; // centerOffset, animThing, and animSpeed
    // added to PEnemy
    // 0x1aa
    public static final int DETAILS_USER_DETAILS = 0x1ab; // userCreatedDetails added to
    // InventoryItemDetails
    ...
    public static final int DETAILS_CREATION_HISTORY = 0x1b1; // added creationHistory to
    // InventoryItemDetails
    // 0x1b2
    // 0x1b3
    // 0x1b4
    ...
    // 0x1c0
    public static final int DETAILS_USES = 0x1c1; // added numUses and lastUsed to
    // InventoryItemDetails
    ...
    // 0x1d4
    public static final int TRIGGER_ZLAYERS = 0x1d5; // added allZLayers to PTrigger, removed
    ...
    public static final int SHARED_SCRIPT_DATA = 0x1ec; // replace all inline script fields with
    ...
    public static final int RENDERMESH_PARENT_DISTANCE = 0x1f6; // added parentDistanceFront/Side
    // to PRenderMesh
    // 0x1f7
    ...
    // 0x203
    // 0x204
    public static final int DETAILS_ALLOW_EMIT = 0x205; // add allowEmit flag to
    // InventoryItemDetails
    // 0x206, added lbp1VOPlayed to RLocalProfile
    // 0x207
    public static final int WORLD_SHAREABLE_REWARDS = 0x208; // added areRewardsShareable to
    ...
    public static final int THING_CREATED_PLAYER = 0x214; // added createdBy and changedBy to
    ...
    public static final int DETAILS_SHAREABLE = 0x223; // add shareable flag to
    // InventoryItemDetails
    ...
    // 0x22d
    public static final int WORLD_SPAWN_FAILURE = 0x22e; // Added everSpawned and
    ...
    public static final int ITEM_FLAGS = 0x235; // Added UID, flags to InventoryItem, add back
    // pad to InventoryItemDetails
    // 0x236
    // 0x237
    public static final int SLOT_DESCRIPTOR = 0x238; // Added shareable and backgroundGUID to Slot
    public static final int MESH_MINMAX_UV = 0x239; // Added min/maxUV and areaScaleFactor to
    // RMesh
    // 0x23a
    ...
    // 0x242
    // 0x243
    public static final int MATERIAL_BULLET = 0x244; // Adds bullet to RMaterial, bulletsRequired
    ...
    // 0x259
    public static final int WORLD_GLOBAL_SETTINGS = 0x25a; // Added global settings fields to
    // PWorld
    ...
    public static final int DECAL_U16_COLOR = 0x260; // replace RGB32 color with RGB565 color in
    // decal
    ...
    public static final int ENEMY_WALK_CONSTRAINT = 0x265; // newWalkConstraintMass added to
    // PEnemy
    ...
    public static final int GROUP_EMITTER = 0x267; // emitter, lifetime, aliveFrames added to
    // PGroup
    ...
    public static final int WATER_LEVEL = 0x26f; // Addede waterLevel and targetWaterLevel to
    // PWorld
    public static final int WATER_MAGNITUDE = 0x270; // Added water wave magnitude fields to
    // PWorld
    ...
    public static final int ARCADE = 0x273; // Robo boots (wall jump), custom guns, recordings,
    // logic
    ...
    public static final int MATERIAL_CIRCUITBOARD = 0x27b; // Add circuitboard and disableCSG to
    // RMaterial
    ...
    public static final int THING_SWAP_UID_PARENT = 0x27f; // swap thing UID and thing parent
    ...
    public static final int INPUT_RIGID_CONNECTORS = 0x288; // added includeRigidConnectors to
    // PSwitchInput
    ...
    public static final int SWITCHINPUT_VISIBILITY = 0x297; // Added hideInPlayMode to
    // PSwitchInput
    public static final int THING_TEST_MARKER = 0x2a1; // Adds test serialization marker to CThing
    public static final int PARAMETER_ANIMATIONS = 0x2a2; // Added parameter animations to
    // RGfxMaterial
    public static final int PLAYER_SIGNAL = 0x2a3; // Added gameMode to PWorld, playerNumberColor
    // to PShape, player to CSwitchSignal
    public static final int RESPONSIBLE_PLAYER = 0x2a5; // responsiblePlayer/frames added to
    // PCreature
    public static final int WORLD_SACKBOT_NUMBER = 0x2b0; // added nextSackbotPlayerNumber to
    // PWorld
    ...
    public static final int MATERIAL_PROPERTIES = 0x2b7; // Restitution, single grab, and sticky
    // added to PMaterialTweak
    public static final int MICROCHIP_WIRE_VISIBILITY = 0x2b8; // Adds wiresVisible to PMicrochip
    public static final int MATERIAL_NO_AUTO_DESTRUCT = 0x2b9; // Added noAutoDestruct to
    // PMaterialTweak
    public static final int MOTION_CONTROLLER_ZONE = 0x2ba; // Add motionControllerZone to
    // PCameraTweak
    public static final int LAMS_KEYS = 0x2bb; // Use LAMS keys instead of translation tags
    public static final int SWITCH_BEHAVIOR = 0x2c4; // Randomiser added, SwitchInput no longer
    // carries signals, behavior added to various structures
    public static final int TEMP_COSTUME = 0x2c5; // Adds costumePieceVec[COSTUME_TEMP_START] to
    // PCostume
    public static final int REMOVE_GAME_UPDATE_FRAME = 0x2c6; // Remove Game.LastUpdateFrame from
    // PEmitter
    ...
    public static final int RENDERMESH_VISIBILITY_FLAGS = 0x2e3; // switch visible to
    ...
    public static final int MICROCHIP_OFFSET = 0x2e9; // Circuitboard board offset added to
    // PMicroChip
    public static final int SLOT_COLLECTABUBBLES_REQUIRED = 0x2ea; // added
    // collectabubblesRequired to slot
    public static final int WORLD_CUTSCENE_MANAGER = 0x2ee; // added cutSceneCameraManager to
    // PWorld
    public static final int THING_HIDDEN = 0x2f2; // added hidden to thing
    public static final int SLOT_COLLECTABUBBLES_CONTAINED = 0x2f4; // added
    ...
    public static final int GUN_MODIFIERS = 0x320; // added fireRate, gunAccuracy,
    ...
    public static final int LEVEL_SETTINGS_AO = 0x325; // added shadow settings and dofNear to
    // PLevelSettings
    public static final int LEVEL_SETTINGS_DOF_FAR = 0x326; // added DofFar to PLevelSettings
    public static final int DROP_POWERUPS = 0x32c; // canDropPowerup added to PCreature, randy
    // seed also removed from pworld?
    public static final int LEVEL_SETTINGS_ZEFFECT = 0x331; // zEffect fields added to
    // PLevelSettings
    ...
    public static final int THING_FLAGS = 0x341; // added flags to thing, remove localPosition
    // from PPos
    public static final int REMOVE_WORLD_TUTORIAL_LEVEL = 0x344; // isTutoriallevel removed from
    // PWorld
    public static final int USER_CATEGORIES = 0x34a; // userCategoryIndex added to InventoryItem
    public static final int WEEKDAYS_PLAYED_PIN = 0x34b; // added weekdaysPlayedBits to
    // PinsAwarded
    public static final int DECAL_PLAN_DESCRIPTOR = 0x34c; // replace decal planGUID with
    // descriptor
    public static final int COMPACT_MICROCHIP = 0x34d; // name, compactComponents, and
    // circuitBoardSizeX/Y added to PMicrochip
    public static final int WORLD_WATER_DRAIN = 0x34e; // Added water drain sounds enabled fields
    // to PWorld
    public static final int SLOT_SUBLEVEL = 0x352; // isSubLevel added to slot
    public static final int SLOT_SCOREBOARD_LINK = 0x35e; // added scoreboardLevelLinkSlot to
    // PWorld
    public static final int REMOVE_LBP1_TUTORIALS = 0x36c; // Removed tutorialLevel and
    ...
    public static final int DETAILS_RELAYOUT_LBP2 = 0x37d; // NetworkOnlineID and NetworkPlayerID
    ...
    public static final int PRODUCTION_BUILD = 0x3b6; // fromProductionBuild added to resources
    // containing slot lists.
    public static final int PAINTING_PHOTO_DATA = 0x3c8; // painting added to
    // InventoryItemPhotoData
    public static final int SLOT_EXTRA_METADATA = 0x3d0; // min/maxPlayers, moveRecommended,
    // showOnPlanet, and livesOverride added to slot
    public static final int PTG_USE_DEFAULT_BACKGROUND = 0x3e0; // add useDefaultBackground to
    // PaintProperties
    public static final int LEVEL_CROSS_DEPENDENCIES = 0x3e6; // Added Vita cross dependency
    // hashes to RLevel
    public static final int SLOT_CROSS_COMPATIBLE = 0x3e9; // crossCompatible added to slot
    public static final int PROFILE_CROSS_DEPENDENCIES = 0x3eb; // Added Vita cross dependency
    // hashes to RBigProfile
    public static final int DATALABELS = 0x3ef;  // Creator data labels added to RBigProfile
    public static final int PIN_LBP1_TROPHY_AWARDED = 0x3f7; // Added a trophy for LBP1 enum to
    // RPin files
    public static final int PROFILE_OWNED_LBP = 0x3f8; // OwnedLBP field added to RLocalProfile

    public static final int LBP2_MAX = 0x3f8; // last revision for lbp2, technically 0x3f9, but
    ...
    public static final int LD_WATER_SETTINGS = 0x0; // Adds scuba gear and water related tweak
    // settings
    public static final int LD_WATER_TINT = 0x1; // Adds water tint and murkiness to PWorld
    public static final int LD_RESOURCES = 0x2; // Remove's depreciated CValue from PMetaData,
    // adds compressionFlags to Resource's, adds compressed parts to CThing
    public static final int LD_SAVEGAME_INFO = 0x3; // Add showSaveGameInfo and totalLevelCount
    // to RLocalProfile
    public static final int LD_WATER_WAVE = 0x4; // Adds Game.CurrWavePos and fromWaterLevel to
    // PWorld
    ...
    // 0x4c44::0x0009
    // 0x4c44:0x000a
    public static final int LD_TEMP_COSTUME = 0xb; // Adds costumePieceVec[COSTUME_TEMP_START] to
    // PCostume
    public static final int LD_REMOVED_HEAD_PIECE = 0xc; // Removes hasBreathedAir from
    // PCreature, or is that headPiece
    public static final int LD_NEWS_TIMESTAMP = 0xd; // Adds lastNewsItemTimestamp to
    // RLocalProfile
    ...
    // 0x4c44:0x0010
    public static final int LD_REMOVED_ENEMY_STAT = 0x11; // Removes enemiesKilled from
    // PlayerMetrics
    ...
    public static final int D1_LABEL_ANALOGUE_ARRAY = 0x33; // Make analogue value from
    ...
    public static final int D1_SLOT_REWARDS = 0x3d; // Added rewards and acingEnabled fields to
    // slot
    ...
    public static final int D1_3G_CONNECTIVITY = 0x58; // added total3gUp/DownStream to
    // RLocalProfile
    ...
    public static final int D1_DEFERRED_PLAYS = 0x5c; // Added deferredPlayCount(Uploaded) to
    // PlayedLevelData
    public static final int D1_SLOT_DOWNLOAD_DATA = 0x5d; // sizeOfResources, sizeOfSubLevels,
    ...
    public static final int D1_UPLOADED_HIGH_SCORE = 0x61; // added uploadedLocalHighScore to
    // PlayedLevelData
    public static final int D1_MOE_PIN_PROGRESS = 0x64; // added moreOfEverythingPinProgress to
    // PinsAwarded
    public static final int D1_CHALLENGE_SCORE = 0x68; // myScore and networkOnlineID added to
    // Challenge
    public static final int D1_TOUCH_CREATE = 0x69; // createRearTouchPan,
    // createRearTouchPinchZoom, createRearTapZoom aded to RLocalProfile
    public static final int D1_TROPHIES = 0x72; // added gold/silver/bronze trophy counts to
    // PlayedLevelDATA
    public static final int D1_CREATE_WARNING = 0x74; // Added createFrameRateWarningMessages to
    // RLocalProfile
    public static final int D1_CREATE_BETA = 0x75; // Added online beta timestamps to
    // RLocalProfile
    public static final int D1_PLANET_DECORATIONS = 0x7b; // Planet decorations added to
    // RBigProfile
    ...
    public static final int COLLECTION_POPPET_POWERUP = 0x9; // added poppetPowerUpSelection to
    // InventoryCollection
    ...
    public static final int WORLD_BACKDROP_OFFSET = 0x6d; // add backdrop offset adjustment
    // fields to PWorld
    ...
    public static final int WORLD_AMBIENCE_OVERRIDE = 0xe2; // added overrideBackdropAmbience to
    // world
    public static final int MOVE_GAMEPLAY_DATA_TYPE = 0xef; // move gameplayType to top of struct
    // in PGameplayData
    public static final int GAMEPLAY_DATA_TREASURE = 0xf3; // treasureType and treasureCount
    ...
    public static final int SLOT_ENTRANCE_DATA = 0x11b; // entranceName and originalSlotID added
    // to slot
    ...
    public static final int FUZZ = 0x16b; // Added fuzzLengthAndRefractiveFlag to RGfxMaterial
    ...
    public static final int FUZZ_LIGHTING = 0x17c; // Added fuzz lighting/swirl fields to
    // RGfxMaterial
    public static final int WORLD_BACKDROP_TOGGLE = 0x182; // added backdropEnabled and
    ...
    public static final int MZ_CGC_PATH = 0x3; // Keep original path of RGfxMaterial in
    // RShaderCache
    ...
    public static final int MZ_SCENE_GRAPH = 0x6; // RSceneGraph added, fields removed in PWorld
    // that are now stored in scene graph, removed thing createdBy indices, add name field to
    // Things
    public static final int MZ_REMOVE_ASPECT = 0x7; // Remove aspectRatio from Camera
    // serialization
    public static final int MZ_REMOVE_GFX_CODE = 0x8; // Removes code from RGfxMaterial for
    // generation on the fly
    public static final int MZ_SCE_DEFAULT_LIGHTING = 0x9; // Serializes lighting in RSceneGraph
    // to use as default.
    public static final int MZ_SCE_PACKED_DATA = 0xa; // Allows storing data in scene graph
    // caches.
    ...
    public static final int LM_TOOLKIT = 0x3; // When mods were added to Toolkit, move icon to
    ...
    public static final int LM_SLOTS_TIMESTAMPS = 0x4; // Timestamps added to each entry, slot
    // array added
    public static final int LM_MINMAX = 0x5; // Added min/max revision to entries, meant for mods
    // to contain multiple versions of gmats/plans, never used.
    public static final int LM_TYPES = 0x6; // author is now str16, itemCount switched from u16
