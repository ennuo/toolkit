      ...
      public static class GLB
      {
            ...
            private int createMaterial(String name, RGfxMaterial gmat)
            {
                ...
                */
                        ...
                        if (box.type == BoxType.TEXTURE_SAMPLE)
                        {
                              ...
                              {
                                    Vector2f col0 =
                                            new Vector2f(Float.intBitsToFloat((int) params[0]),
                                            Float.intBitsToFloat((int) params[1]));
                                    Vector2f col1 =
                                            new Vector2f(Float.intBitsToFloat((int) params[3]),
                                            Float.intBitsToFloat((int) params[6]));
                                    ...
                                    textureOffset =
                                            new float[] { Float.intBitsToFloat((int) params[2]),
                                            Float.intBitsToFloat((int) params[7]) };
                              ...
                              {
                                    textureScale =
                                            new float[] { Float.intBitsToFloat((int) params[0]),
                                            Float.intBitsToFloat((int) params[1]) };
                                    textureOffset =
                                            new float[] { Float.intBitsToFloat((int) params[2]),
                                            Float.intBitsToFloat((int) params[3]) };
                              ...
                              switch (wire.portTo)
                              {
                                    case 0:
                                          ...
                                          System.out.println(String.format("%s:%d",
                                                  Paths.get(entry.getPath()).getFileName().toString().replaceFirst("[.][^.]+$", ""), image.getTransparency()));
                        ...
                        else if (box.type == BoxType.COLOR)
                        {
                              ...
                              if (wire.boxTo == outputBox)
                              {
                                    int[] params = box.getParameters();
                                    float[] color =
                                            new float[] { Float.intBitsToFloat((int) params[0]) / 255f,
                                            Float.intBitsToFloat((int) params[1]) / 255f,
                                            Float.intBitsToFloat((int) params[2]) / 255f,
                                            Float.intBitsToFloat((int) params[3]) / 255f };
                                    if (wire.portTo == 0)
                                    {
                                          if (material.getExtensions() != null && material.getExtensions().containsKey("KHR_materials_pbrSpecularGlossiness"))
                                          {
            ...
            private byte[] getBufferFromAnimation(RAnimation animation)
            {
                  ...
                  for (int i = 0; i < bones.length; ++i)
                  {
                        ...
                        if (animation.isAnimated(bone, AnimationType.POSITION))
                        {
                              ...
                              createBufferView("BONE_TRANSLATION_" + String.valueOf(bone.animHash),
                        ...
                        if (animation.isAnimated(bone, AnimationType.ROTATION))
                        {
                              ...
                              createBufferView("BONE_ROTATION_" + String.valueOf(bone.animHash),
                                      rotStart,
                        ...
                        if (animation.isAnimated(bone, AnimationType.SCALE))
                        {
                              ...
                              createBufferView("BONE_SCALE_" + String.valueOf(bone.animHash),
                                      scaleStart,
            ...
            private byte[] getBufferFromMesh(RStaticMesh mesh)
            {
                  ...
                  for (int i = 0; i < primitives.length; ++i)
                  {
                        ...
                        createBufferView("INDICES_" + String.valueOf(i), primitiveStart,
            ...
            private byte[] getBufferFromMesh(RMesh mesh)
            {
                  ...
                  for (int i = 0; i < subMeshes.length; ++i)
                  {
                        for (int j = 0; j < subMeshes[i].length; ++j)
                        {
                              ...
                              createBufferView("INDICES_" + String.valueOf(i) + "_" + String.valueOf(j),
                  ...
                  for (int i = 0; i < mesh.getAttributeCount(); ++i)
                  {
                        ...
                        createBufferView("TEXCOORD_" + String.valueOf(i), uvStart,
                  ...
                  if (mesh.getMorphCount() != 0)
                  {
                        ...
                        for (int i = 0; i < mesh.getMorphCount(); ++i)
                        {
                              ...
                              createBufferView("MORPH_" + String.valueOf(i), morphStart,
                                      output.getOffset() - morphStart);
                        }
                        ...
                        for (int i = 0; i < mesh.getMorphCount(); ++i)
                        {
                              ...
                              createBufferView("MORPH_NORMAL_" + String.valueOf(i), morphStart,
                                      output.getOffset() - morphStart);
                        }
                  }
