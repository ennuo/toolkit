...
public class FieldSerializer implements JsonSerializer<FieldLayoutDetails>,
    JsonDeserializer<FieldLayoutDetails>
{
    @Override
    public FieldLayoutDetails deserialize(JsonElement je, Type type,
    ...
    throws JsonParseException
    {
        ...
        if (object.has("modifiers"))
            layout.modifiers = jdc.deserialize(object.get("modifiers"),
                TypeToken.getParameterized(EnumSet.class, ModifierType.class).getType());
        if (object.has("machineType"))
            layout.machineType = jdc.deserialize(object.get("machineType"),
                MachineType.class);
        ...
        if (object.has("arrayBaseMachineType"))
            layout.arrayBaseMachineType = jdc.deserialize(object.get("arrayBaseMachineType"),
                MachineType.class);
        ...
        if (object.has("value"))
        {
            ...
            {
                case BOOL:
                    layout.value = object.get("value").getAsBoolean();
                    break;
                case CHAR:
                    layout.value = object.get("value").getAsByte();
                    break;
                case S32:
                    layout.value = object.get("value").getAsInt();
                    break;
                case F32:
                    layout.value = object.get("value").getAsFloat();
                    break;
                case V4:
                    layout.value = jdc.deserialize(object.get("value"), Vector4f.class);
                    break;
                case M44:
                    layout.value = jdc.deserialize(object.get("value"), Matrix4f.class);
                    break;
                case OBJECT_REF:
                    ...
                    break;
                case SAFE_PTR:
                    layout.value = jdc.deserialize(object.get("value"), Thing.class);
                    break;
                default:
                    break;
            }
    ...
    @Override
    public JsonElement serialize(FieldLayoutDetails layout, Type type,
                                 JsonSerializationContext jsc)
    {
        ...
        if (layout.value != null)
        {
            ...
            {
                case BOOL:
                    object.add("value", new JsonPrimitive((boolean) layout.value));
                    break;
                case CHAR:
                    object.add("value", new JsonPrimitive((byte) layout.value));
                    break;
                case S32:
                    object.add("value", new JsonPrimitive((int) layout.value));
                    break;
                case F32:
                    object.add("value", new JsonPrimitive((float) layout.value));
                    break;
                case V4:
                    object.add("value", jsc.serialize(layout.value, Vector4f.class));
                    break;
                case M44:
                    object.add("value", jsc.serialize(layout.value, Matrix4f.class));
                    break;
                case OBJECT_REF:
