...
public class MemoryInputStream
{
    ...
    {
        if (buffer == null)
            throw new NullPointerException("Buffer supplied to MemoryInputStream cannot be " +
                                           "null!");
        this.buffer = buffer;
    ...
    {
        if (path == null)
            throw new NullPointerException("Path supplied to MemoryInputStream cannot be " +
                                           "null!");
    ...
    {
        return Float.intBitsToFloat(this.i32(true));
    }
