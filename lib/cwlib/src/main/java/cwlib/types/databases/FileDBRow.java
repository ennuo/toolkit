...
public final class FileDBRow extends FileEntry
{
    ...
    public FileDBRow(FileDB database, String path, long date, long size, SHA1 sha1, GUID guid)
    {
        ...
        if (sha1 == null)
            throw new NullPointerException("File SHA1 provided to FileDBRow constructor " +
                                           "cannot be" +
                                           " null!");
        if (guid == null)
            throw new NullPointerException("GUID provided to FileDBRow constructor cannot " +
                                           "be " +
                                           "null!");
