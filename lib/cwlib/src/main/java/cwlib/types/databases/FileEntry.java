...
public abstract class FileEntry
{
     ...
     * If one wants to create an entry in a database, they should refer to FileDB.newFileEntry
     * instead.
     *
    ...
    {
        if (path == null)
            throw new NullPointerException("Path provided to FileEntry constructor cannot " +
                                           "be " +
                                           "null!");
        if (source == null)
            throw new NullPointerException("File database provided to FileEntry constructor" +
                                           " " +
                                           "cannot be null!");
        if (sha1 == null)
            throw new NullPointerException("File SHA1 provided to FileEntry constructor " +
                                           "cannot be" +
                                           " null!");
    ...
    public void setPath(String path)
    {
        ...
        if (this.node != null)
        {
            ...
            this.node =
                Nodes.addNode((FileNode) this.getSource().getTree().getModel().getRoot(),
                    this);
        }
