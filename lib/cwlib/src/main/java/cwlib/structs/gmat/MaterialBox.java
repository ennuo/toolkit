...
public class MaterialBox implements Serializable
{
      ...
      public float getTextureRotation()
      {
            ...
            Vector2f col0 = new Vector2f(Float.intBitsToFloat((int) params[0]),
      ...
      public Vector4f getTextureTransform()
      {
            ...
            else
            {
                  Vector2f col0 = new Vector2f(Float.intBitsToFloat((int) params[0]),
                          Float.intBitsToFloat((int) params[1]));
                  Vector2f col1 = new Vector2f(Float.intBitsToFloat((int) params[3]),
                          Float.intBitsToFloat((int) params[6]));
                  return new Vector4f(col0.length(), col1.length(),
                          Float.intBitsToFloat((int) params[2]),
      ...
      public boolean isSimpleMultiply(RGfxMaterial material)
      {
            ...
            if (ports[0].type == BoxType.COLOR && ports[1].type == BoxType.TEXTURE_SAMPLE)
                  return true;
            if (ports[0].type == BoxType.TEXTURE_SAMPLE && ports[1].type == BoxType.COLOR)
                  return true;
