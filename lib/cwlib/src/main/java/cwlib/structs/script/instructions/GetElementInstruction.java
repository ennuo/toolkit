...
public class GetElementInstruction extends Instruction
{
    ...
    public GetElementInstruction(InstructionType type)
    {
        super(type);
    }

    public GetElementInstruction(long bits)
    {
        super(InstructionType.fromValue((int) (bits & 0xff)));

        this.source = (short) ((bits >>> 48) & 0xffff);
    ...
    public long getBits()
    {
        return (((long) this.source & 0xffff) << 48) |
