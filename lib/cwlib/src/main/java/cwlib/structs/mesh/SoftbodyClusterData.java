...
public class SoftbodyClusterData implements Serializable, Iterable<SoftbodyCluster>
{
    ...
    public void serialize(Serializer serializer)
    {
        ...
        if (serializer.isWriting())
        {
            ...
            {
                SoftbodyCluster cluster = clusters.get(i);
        ...
        for (int i = 0; i < clusterCount; ++i)
        {
            ...
            cluster.setRestQuadraticDyadicSum(
                Arrays.copyOfRange(restQuadraticDyadicSum, offset,
                    offset + SoftbodyCluster.QUAD_DYADIC_SUM_LENGTH)
            );
    ...
    @Override
    public Iterator<SoftbodyCluster> iterator()
    {
        return this.clusters.iterator();
    }

    public ArrayList<SoftbodyCluster> getClusters()
    {
