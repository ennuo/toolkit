...
public class Images
{
    ...
    {
        int[] ARGB = image.getRGB(0, 0, image.getWidth(), image.getHeight(), null, 0,
            image.getWidth());
    ...
    private static byte[] toDDS(BufferedImage image, Squish.CompressionType type,
    ...
    public static byte[] toGTF(BufferedImage image, Squish.CompressionType type, boolean noSRGB,
                               boolean generateMips)
    {
    ...
    public static byte[] toTEX(BufferedImage image, Squish.CompressionType type, boolean noSRGB,
                               boolean generateMips)
    {
        byte[] dds = toDDS(image, type, generateMips);
    ...
    public static BufferedImage getOverlayedImage(BufferedImage background,
                                                  BufferedImage foreground, int x, int y,
                                                  boolean drawForegroundRelative)
    {
    ...
    public static BufferedImage getBufferedImageScaled(BufferedImage image, int width, int height)
    {
        if (image.getWidth() != image.getHeight())
            image = image.getSubimage(image.getWidth() / 4, 0, image.getHeight(),
                image.getHeight());
    ...
    public static ImageIcon getAdventureIcon(BufferedImage master)
    {
        ...
        {
            if (master == null)
                master = ImageIO.read(Images.class.getResource("/images/slots/backdrop" +
                                                               ".png"));
    ...
    public static ImageIcon getGroupIcon(BufferedImage master)
    {
        ...
        try
        {
            BufferedImage image = ImageIO.read(Images.class.getResource("/images/slots" +
                                                                        "/polaroid" +
                                                                        ".png"));
    ...
    public static ImageIcon getSlotIcon(BufferedImage master, int revision)
    {
        ...
        BufferedImage mask = new BufferedImage(master.getWidth(), master.getHeight(),
