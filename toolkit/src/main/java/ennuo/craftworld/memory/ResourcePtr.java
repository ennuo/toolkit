...
public class ResourcePtr {
    ...
    public ResourcePtr(long GUID, RType type) { this.GUID = GUID; this.type = type; }
    public ResourcePtr(byte[] SHA1, RType type) { this.hash = SHA1; this.type = type; }
