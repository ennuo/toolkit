...
{
    public static final int[] HEADERS = { 0x54455820, 0x47544620, 0x47544673, 0x47544653,
        0x89504e47, 0xFFD8FFE0, 0x44445320 };
    ...
    public void process(JTree tree, FileEntry entry, byte[] data)
    {
        ...
        if (texture == null)
        {
            System.out.println("Failed to create Texture instance, is this an appropriate " +
                               "resource?");
            return;
        }
