...
public class SettingsManager extends javax.swing.JDialog
{
    public SettingsManager(Frame parent)
    {
        ...
        this.useLegacyFileDialogueCheckbox.addActionListener(l -> config.useLegacyFileDialogue =
            this.useLegacyFileDialogueCheckbox.isSelected());
    ...
    private void isDebugCheckboxActionPerformed(java.awt.event.ActionEvent evt)
    {//GEN-FIRST:event_isDebugCheckboxActionPerformed
