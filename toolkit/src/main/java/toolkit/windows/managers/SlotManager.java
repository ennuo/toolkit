...
public class SlotManager extends javax.swing.JFrame
{
      ...
      {
            int result = JOptionPane.showConfirmDialog(null, "Do you want to save your changes?",
            ...
            if (result == JOptionPane.YES_OPTION)
            {
                  ...
                  else if (this.type == EditorType.ADVENTURE)
                  {
                        ...
                        compressable = new RSlotList(this.slots);
                  ResourceSystem.replace(this.entry, SerializedResource.compress(compressable,
                          info.getRevision()
                          , info.getCompressionFlags()));
            }
            this.dispose();
      }
      ...
      private void setup()
      {
            ...
            this.addSlotButton.addActionListener(e ->
            {
                  ...
                  if (this.type == EditorType.SAVE)
                        slot.location =
                                Crater.valueOf("SLOT_" + (slot.id.slotNumber % 82) + "_LBP" + this.game).getValue();
                  else
                        slot.location =
                                Crater.valueOf("SLOT_" + SlotManager.RNG.nextInt(82) + "_LBP" + this.game).getValue();
      ...
      {
            this.levelTypeCombo.addActionListener(e -> this.selectedSlot.developerLevelType =
                    (LevelType) this.levelTypeCombo.getSelectedItem());
            this.gameModeCombo.addActionListener(e -> this.selectedSlot.gameMode =
                    ((GameMode) this.gameModeCombo.getSelectedItem()).getValue());

            this.badgeSizeSpinner.addChangeListener(e -> this.selectedSlot.customBadgeSize =
                    (byte) this.badgeSizeSpinner.getValue());

            this.minPlayerSpinner.addChangeListener(e -> this.selectedSlot.minPlayers =
                    (byte) this.minPlayerSpinner.getValue());
            this.maxPlayerSpinner.addChangeListener(e -> this.selectedSlot.maxPlayers =
                    (byte) this.maxPlayerSpinner.getValue());
            this.enforcePlayerCheckbox.addChangeListener(e -> this.selectedSlot.enforceMinMaxPlayers
                    = this.enforcePlayerCheckbox.isSelected());
            ...
            this.planetDecorationTextEntry.addActionListener(e ->
            {
                  ...
                  if (Strings.isGUID(descriptor) || Strings.isSHA1(descriptor))
                        this.selectedSlot.planetDecorations = new ResourceDescriptor(descriptor,
                                ResourceType.LEVEL);
            });
            ...
            this.locationXSpinner.addChangeListener(e -> this.selectedSlot.location.x =
                    (float) this.locationXSpinner.getValue());
            this.locationYSpinner.addChangeListener(e -> this.selectedSlot.location.y =
                    (float) this.locationYSpinner.getValue());
            this.locationZSpinner.addChangeListener(e -> this.selectedSlot.location.z =
                    (float) this.locationZSpinner.getValue());
            this.locationWSpinner.addChangeListener(e -> this.selectedSlot.location.w =
                    (float) this.locationWSpinner.getValue());

            this.lockedCheckbox.addChangeListener(e -> this.selectedSlot.initiallyLocked =
                    this.lockedCheckbox.isSelected());
            this.subLevelCheckbox.addChangeListener(e -> this.selectedSlot.isSubLevel =
                    this.subLevelCheckbox.isSelected());
            this.moveCheckbox.addChangeListener(e -> this.selectedSlot.moveRecommended =
                    this.moveCheckbox.isSelected());
            this.shareableCheckbox.addChangeListener(e -> this.selectedSlot.shareable =
                    this.shareableCheckbox.isSelected());
            this.gameKitCheckbox.addChangeListener(e -> this.selectedSlot.isGameKit =
                    this.gameKitCheckbox.isSelected());
            this.visibleCheckbox.addChangeListener(e -> this.selectedSlot.showOnPlanet =
                    this.visibleCheckbox.isSelected());
            this.crossControllerCheckbox.addChangeListener(e -> this.selectedSlot.crossCompatible =
                    this.crossControllerCheckbox.isSelected());
      }
      ...
      private void setupDetailsListeners()
      {
            ...
            this.iconTextEntry.addActionListener(e ->
            {
                  ...
                  {
                        ResourceDescriptor descriptor = new ResourceDescriptor(text,
            ...
            this.creatorTextEntry.addActionListener(e -> this.selectedSlot.authorName =
                    this.creatorTextEntry.getText());
      ...
      private void setupDataListeners()
      {
            this.rootLevelTextEntry.addActionListener(e ->
            {
                  ...
                  if (Strings.isGUID(descriptor) || Strings.isSHA1(descriptor))
                        this.selectedSlot.root = new ResourceDescriptor(descriptor,
                                ResourceType.LEVEL);
            });
            ...
            this.adventureTextEntry.addActionListener(e ->
            {
                  ...
                  if (Strings.isGUID(descriptor) || Strings.isSHA1(descriptor))
                        this.selectedSlot.adventure = new ResourceDescriptor(descriptor,
            ...
            {
                  SlotID oldSlotID = new SlotID(this.selectedSlot.id.slotType,
                          this.selectedSlot.id.slotNumber);
      ...
      private void setupDLCListeners()
      {
            ...
            this.badgeMeshTextEntry.addActionListener(e ->
            {
                  ...
                  if (Strings.isGUID(descriptor) || Strings.isSHA1(descriptor))
                        this.selectedItem.mesh = new ResourceDescriptor(descriptor,
                                ResourceType.MESH);
            });

            this.contentIDTextEntry.addActionListener(e -> this.selectedItem.contentID =
                    this.contentIDTextEntry.getText());
      ...
      private void updateTranslations()
      {
            ...
            else
            {
                  ...
                  this.descriptionTextEntry.setText("A valid translation table needs to be loaded" +
                                                    ...
                                                    "Alternatively, remove the translation " +
                                                    "key, and set your own title/description.");
      ...
      private void initComponents()
      {
                            ...
                            .addGroup(slotIDPaneLayout.createSequentialGroup()
                                    ...
                                    .addGroup(slotIDPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(slotIDPaneLayout.createSequentialGroup()
                                                    ...
                                                    .addGroup(slotIDPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                            .addComponent(slotTypeCombo, 0, 388,
                                                                    Short.MAX_VALUE)
            ...
            javax.swing.GroupLayout dataContainerLayout =
                    new javax.swing.GroupLayout(dataContainer);
            ...
            dataContainerLayout.setHorizontalGroup(
                    dataContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(slotIDPane, javax.swing.GroupLayout.Alignment.TRAILING,
                                    javax.swing.GroupLayout.DEFAULT_SIZE,
                                            ...
                                            .addGroup(dataContainerLayout.createSequentialGroup()
                                                    ...
                                                    .addGroup(dataContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                            ...
                                                            .addComponent(selectAdventureButton,
                                                                    javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                            .addGroup(dataContainerLayout.createSequentialGroup()
                                                    .addGroup(dataContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    ...
                                                    .addGap(18, 18, 18)
                                                    .addGroup(dataContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                            .addComponent(linkCombo, 0,
                                                                    javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                            .addComponent(groupCombo, 0,
                                                                    javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                                    .addContainerGap())
            );
            ...
            dataPaneLayout.setHorizontalGroup(
                    dataPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(dataContainer, javax.swing.GroupLayout.DEFAULT_SIZE,
                                    javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            );
            ...
            minPlayerSpinner.setModel(new javax.swing.SpinnerNumberModel(Byte.valueOf((byte) 1),
                    Byte.valueOf((byte) 1), Byte.valueOf((byte) 4), Byte.valueOf((byte) 1)));

            maxPlayerSpinner.setModel(new javax.swing.SpinnerNumberModel(Byte.valueOf((byte) 4),
                    Byte.valueOf((byte) 1), Byte.valueOf((byte) 4), Byte.valueOf((byte) 1)));

            enforcePlayerCheckbox.setText("Enforce");

            badgeSizeSpinner.setModel(new javax.swing.SpinnerNumberModel((byte) 1, (byte) 0, null,
                    (byte) 1));
                            ...
                            .addGroup(settingsPaneLayout.createSequentialGroup()
                                    ...
                                    .addGroup(settingsPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(settingsPaneLayout.createSequentialGroup()
                                                    ...
                                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                    .addGroup(settingsPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                            .addComponent(levelTypeCombo, 0,
                                                                    javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                            .addComponent(gameModeCombo, 0,
                                                                    javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, settingsPaneLayout.createSequentialGroup()
                                                                    ...
                                                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                    .addComponent(minPlayerSpinner,
                                                                            javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                    .addComponent(maxPlayerSpinner,
                                                                            javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                    .addComponent(enforcePlayerCheckbox))))
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                    settingsPaneLayout.createSequentialGroup()
                                                            .addGroup(settingsPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            settingsPaneLayout.setVerticalGroup(
                    settingsPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(settingsPaneLayout.createSequentialGroup()
                                    ...
                                    .addComponent(flagsLabel)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(flagsPane, javax.swing.GroupLayout.PREFERRED_SIZE,
                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                            javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18))
            );
            ...
            dlcPaneLayout.setHorizontalGroup(
                    dlcPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(dlcPaneLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addGroup(dlcPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(badgeMeshTextEntry,
                                                    javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addComponent(contentIDTextEntry,
                                                    javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addComponent(timestampSpinner,
                                                    javax.swing.GroupLayout.DEFAULT_SIZE, 365,
                                                    Short.MAX_VALUE)
                                            .addComponent(contentsTypeCombo, 0,
                                                    javax.swing.GroupLayout.DEFAULT_SIZE,
                                                    Short.MAX_VALUE))
                                    .addContainerGap())
            );
                    ...
                    dlcPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(dlcPaneLayout.createSequentialGroup()
                                    ...
                                    .addGroup(dlcPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                            .addComponent(contentsTypeLabel)
                                            .addComponent(contentsTypeCombo,
                                                    javax.swing.GroupLayout.PREFERRED_SIZE,
                                                    javax.swing.GroupLayout.DEFAULT_SIZE,
                                                    javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
      ...
      private void selectRootLevelButtonActionPerformed(java.awt.event.ActionEvent evt)
      {//GEN-FIRST:event_selectRootLevelButtonActionPerformed
      ...
      private void selectAdventureButtonActionPerformed(java.awt.event.ActionEvent evt)
      {//GEN-FIRST:event_selectAdventureButtonActionPerformed
