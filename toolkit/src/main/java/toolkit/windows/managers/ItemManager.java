...
public class ItemManager extends javax.swing.JFrame
{
    ...
    private void onClosePlan()
    {
        ...
        if (!newHash.equals(this.originalDetailsHash))
        {
            ...
            if (result == JOptionPane.YES_OPTION)
            {
                ...
                ResourceSystem.replace(this.entry, SerializedResource.compress(plan,
                    plan.revision,
                    plan.compressionFlags));
            }
        }
        this.dispose();
    }
    ...
    private void saveItem(InventoryItemDetails details, InventoryItem item)
    {
        ...
        {
            // If we're editing a profile, categories/locations are resolved by index in
            // string
            // table
            details.categoryIndex =
                (short) this.profile.getProfile().stringTable.add(this.categoryTextEntry.getText(), 0);
            details.locationIndex =
                (short) this.profile.getProfile().stringTable.add(this.locationTextEntry.getText(), 0);
        }
    ...
    private void initComponents() {
        ...
        titleDescPaneLayout.setHorizontalGroup(
            ...
            .addGroup(titleDescPaneLayout.createSequentialGroup()
                ...
                .addGap(12, 12, 12)
                .addComponent(descriptionKeyTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE))
        );
    ...
    {//GEN-FIRST:event_addItemButtonActionPerformed
