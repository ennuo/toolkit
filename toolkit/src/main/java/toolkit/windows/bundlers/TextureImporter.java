...
public class TextureImporter extends javax.swing.JDialog
{
    ...
    private void initComponents()
    {
        ...
        textureFormatLabel.setToolTipText("DDS compression method for texture, if unsure " +
                                          "leave as" +
                                          " DXT5");

        textureFormatCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {
            "DXT1",
            "DXT3", "DXT5" }));
                ...
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGap(15, 15, 15)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(textureFormatCombo, 0,
                                    javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(textureFormatLabel)
                                .addComponent(textureFormatCombo,
                                    javax.swing.GroupLayout.PREFERRED_SIZE,
                                    javax.swing.GroupLayout.DEFAULT_SIZE,
                                    javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGap(5, 5, 5)
    ...
    {//GEN-FIRST:event_openFileButtonActionPerformed
        ...
        if (imageData == null)
        {
            JOptionPane.showMessageDialog(this, "Failed to read file, does it exist?",
                "Texture " +
        ...
        if (this.image == null)
        {
            JOptionPane.showMessageDialog(this, "Failed to load image, is it valid?",
                "Texture " +
                "Importer", JOptionPane.ERROR_MESSAGE);
            return;
        }
