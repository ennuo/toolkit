...
public class Compressinator extends javax.swing.JFrame
{
    ...
    private void update()
    {
        ...
        boolean hasRevision =
            type != ResourceType.FILE_OF_BYTES && type != ResourceType.TEXTURE && type != ResourceType.GTF_TEXTURE;
        boolean hasBranchRevision =
            hasRevision && this.revision.getVersion() >= Revisions.BRANCHES;
        boolean hasCompressionFlags =
            hasRevision && ((this.revision.getVersion() >= 0x297) || this.revision.after(Branch.LEERDAMMER, Revisions.LD_RESOURCES));
    ...
    private void initComponents()
    {
                ...
                .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(resourceCombo, 0,
                                    javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(revisionSpinner)
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                    jPanel1Layout.createSequentialGroup()
                                    .addComponent(branchCombo, 0,
                                        80,
                                        Short.MAX_VALUE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(branchSpinner,
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(compressionFlagsLabel,
                                    ...
                                    javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addComponent(zlibCheckbox,
                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(5, 5, 5)
                                    .addComponent(integersCheckbox,
                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(5, 5, 5)
        ...
        javax.swing.GroupLayout dependencyPanelLayout =
            new javax.swing.GroupLayout(dependencyPanel);
            ...
            dependencyPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(dependencyPanelLayout.createSequentialGroup()
                    ...
                    .addGroup(dependencyPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(dependencyListContainer,
                ...
                .addGroup(gtfPanelLayout.createSequentialGroup()
                    ...
                    .addGroup(gtfPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(mipsLabel,
                            ...
                            javax.swing.GroupLayout.DEFAULT_SIZE,
                            javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(formatLevel,
                            javax.swing.GroupLayout.PREFERRED_SIZE,
                            javax.swing.GroupLayout.DEFAULT_SIZE,
                            javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(gtfPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(formatCombo, 0,
                            javax.swing.GroupLayout.DEFAULT_SIZE,
                            Short.MAX_VALUE)
        ...
        javax.swing.GroupLayout textureInfoPanelLayout =
            new javax.swing.GroupLayout(textureInfoPanel);
        ...
        textureInfoPanelLayout.setHorizontalGroup(
            textureInfoPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(gtfPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
                    javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        textureInfoPanelLayout.setVerticalGroup(
            textureInfoPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(textureInfoPanelLayout.createSequentialGroup()
                    .addComponent(gtfPanel, javax.swing.GroupLayout.PREFERRED_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(noSRGBCheckbox))
    ...
    {//GEN-FIRST:event_compressButtonActionPerformed
        if (this.dataSource == null)
        {
            JOptionPane.showMessageDialog(this, "You have to select a file to compress!",
                "An " +
        ...
        if (type == ResourceType.TEXTURE)
        {
            ...
            resource = SerializedResource.compress(new SerializationData(data), isCompressed);
        }
        else if (type == ResourceType.GTF_TEXTURE)
        {
            ...
            resource = SerializedResource.compress(new SerializationData(this.dataSource,
                    texture),
                isCompressed);
        }
        ...
        else
        {
            ...
            boolean hasCompressionFlags =
                (this.revision.getVersion() >= Revisions.COMPRESSED_RESOURCES) || (this.revision.after(Branch.LEERDAMMER, Revisions.LD_RESOURCES));

            if (hasCompressionFlags)
            {
                if (this.integersCheckbox.isSelected())
                    compressionFlags |= CompressionFlags.USE_COMPRESSED_INTEGERS;
                if (this.matrixCheckbox.isSelected())
                    compressionFlags |= CompressionFlags.USE_COMPRESSED_MATRICES;
                if (this.vectorsCheckbox.isSelected())
            ...
            resource = SerializedResource.compress(data, isCompressed);
        }
        ...
        if (FileIO.write(resource, file.getAbsolutePath()))
            JOptionPane.showMessageDialog(this,
                "Successfully wrote file to " + file.getAbsolutePath(), "Compressinator",
                JOptionPane.INFORMATION_MESSAGE);
        else
            JOptionPane.showMessageDialog(this, "Failed to write file, is it in use?",
                "Compressinator", JOptionPane.ERROR_MESSAGE);

    }//GEN-LAST:event_compressButtonActionPerformed

    private void addDependencyButtonActionPerformed(java.awt.event.ActionEvent evt)
    {//GEN-FIRST:event_addDependencyButtonActionPerformed
    ...
    private void removeDependencyButtonActionPerformed(java.awt.event.ActionEvent evt)
    {//GEN-FIRST:event_removeDependencyButtonActionPerformed
