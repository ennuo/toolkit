...
{
    private SerializedResource resource;
    ...
    public Dependinator(Toolkit toolkit, FileEntry entry)
    {
        ...
        this.resource = new SerializedResource(data);
    ...
    private void onTextChange()
    {
        ...
        Dependentry dependentry =
            this.model.getElementAt(this.descriptorList.getSelectedIndex());
    ...
    private void updateDescriptorButtonActionPerformed(java.awt.event.ActionEvent evt)
    {//GEN-FIRST:event_updateDescriptorButtonActionPerformed
        int index = this.descriptorList.getSelectedIndex();
        if (index == -1) return;
    ...
    {//GEN-FIRST:event_saveChangesButtonActionPerformed
    ...
    private void removeDescriptorButtonActionPerformed(java.awt.event.ActionEvent evt)
    {//GEN-FIRST:event_removeDescriptorButtonActionPerformed
        int index = this.descriptorList.getSelectedIndex();
